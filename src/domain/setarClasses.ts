...
export interface SetarClassSession {
  ...
  pdfs: string[];
  /** Other docs worth linking (images, .docx …), relative NAS paths. */
  docs?: string[];
}

// The array below is regenerated by `npm run scan:setar` between these markers.
// [scan:begin]
export const SETAR_CLASS_SESSIONS: SetarClassSession[] = [
  { n: 1, date: "2023-09-26", video: "setar-classes/session-1-26-09-2023/video-2023-09-27-07-14-52-1.mp4", sizeBytes: 47321598, pdfs: ["setar-classes/session-1-26-09-2023/chahar-mezarabe-avale-dashti.pdf","setar-classes/session-1-26-09-2023/renge-mahoor-darvish-sevom-1402-05-22.pdf"], docs: ["setar-classes/session-1-26-09-2023/4mez-aval-dashti.1.jpg"] },
  ...
  { n: 4, date: "2023-12-22", video: "setar-classes/session-4-22-12-2023/video-20231222-154903-meeting-recording.mp4", sizeBytes: 456964612, pdfs: [], docs: ["setar-classes/session-4-22-12-2023/تصحیح-نت-بسته-نگار.jpg","setar-classes/session-4-22-12-2023/تصحیح-نت-چهار-پاره.jpg","setar-classes/session-4-22-12-2023/تمرین-دشتی-۳.jpg"] },
