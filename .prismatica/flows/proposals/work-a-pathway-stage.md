...
proposalType: update
reason: "Change 20260923-let-an-existing-install-add-a-missing-sh-7e4b replaces
  Repertoire's empty-list-only 'Restore default pathways' with one 'Add default
  pathway: <name>' button per missing shipped default (the approved Delta
  20260923-before-step-1-repertoire-pathways-offers-8b03). Steps are unchanged;
  one variation and the Repertoire touchpoint are added."
proposedBy: agent
createdAt: 2026-09-23T17:24:40.271Z
status: works
presentation:
...
**Reason:** Change 20260923-let-an-existing-install-add-a-missing-sh-7e4b replaces Repertoire's empty-list-only 'Restore default pathways' with one 'Add default pathway: <name>' button per missing shipped default (the approved Delta 20260923-before-step-1-repertoire-pathways-offers-8b03). Steps are unchanged; one variation and the Repertoire touchpoint are added.
